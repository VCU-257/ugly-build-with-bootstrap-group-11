# Student Name: Katang Phuthongthiam
...
One challenge was making sure the navbar and footer were consistent across all pages. I solved this by reusing the exact same Bootstrap code and updating only the active navigation link when needed. Another challenge was organizing the checkout layout with both a form and an order summary. I used Bootstrap’s grid system (row and columns) to properly align these sections.

## 4. AI / LLM Usage
**What I asked the AI:** "How do I create a checkout form and cart layout using Bootstrap 5?" and "How do I keep a consistent navbar across multiple HTML pages?"
